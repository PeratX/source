...
int __fastcall TeleportDescription::parseData(TeleportDescription *this, Json::Value *a2)
{
  Json::Value *v2; // r4@1
  TeleportDescription *v3; // r5@1
  float v4; // ST00_4@1
  float v5; // ST00_4@1
  Vec3 *v6; // ST00_4@1
  float v7; // ST00_4@1
  ...
  float v9; // ST00_4@1
  float v10; // ST00_4@1
  bool v12; // [sp+0h] [bp-20h]@0
  char v13[4]; // [sp+4h] [bp-1Ch]@1
  signed int v14; // [sp+8h] [bp-18h]@1
  signed int v15; // [sp+Ch] [bp-14h]@1

  v2 = a2;
  v3 = this;
  j_Parser::parse(a2, (TeleportDescription *)((char *)this + 4), (bool *)"randomTeleports", (const char *)1, v12);
  j_Parser::parse(v2, (TeleportDescription *)((char *)v3 + 8), (float *)"minRandomTeleportTime", 0, v4);
  j_Parser::parse(
    v2,
    (TeleportDescription *)((char *)v3 + 12),
    (float *)"maxRandomTeleportTime",
    (const char *)0x41A00000,
    v5);
  *(_DWORD *)v13 = 1107296256;
  v14 = 1098907648;
  v15 = 1107296256;
  j_Parser::parse(v2, (TeleportDescription *)((char *)v3 + 16), (Vec3 *)"randomTeleportCube", v13, v6);
  j_Parser::parse(v2, (TeleportDescription *)((char *)v3 + 28), (float *)"targetDistance", (const char *)0x41800000, v7);
    (TeleportDescription *)((char *)v3 + 32),
    (float *)"target_teleport_chance",
    (const char *)0x3F800000,
    v8);
    (TeleportDescription *)((char *)v3 + 36),
    (float *)"lightTeleportChance",
    (const char *)0x3C23D70A,
    v9);
  return j_Parser::parse(
           v2,
           (TeleportDescription *)((char *)v3 + 40),
           (float *)"darkTeleportChance",
           (const char *)0x3C23D70A,
           v10);
}


void __fastcall TeleportDescription::getDocumentation(int a1, int a2)
{
  TeleportDescription::getDocumentation(a1, a2);
}
...
void __fastcall TeleportDescription::getDocumentation(int a1, int a2)
{
  ...
  v2 = a2;
  sub_21E94B4((void **)&v106, "randomTeleports");
  sub_21E94B4((void **)&v105, "true");
  v3 = (int *)sub_21E94B4((void **)&v104, "If true, the entity will teleport randomly");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::BOOLEAN_TYPE, (const void **)&v106, &v105, v3);
  v4 = (void *)(v104 - 12);
  ...
  if ( (int *)(v106 - 12) != &dword_28898C0 )
    ...
    if ( v40 <= 0 )
      j_j_j_j__ZdlPv_9(v6);
  sub_21E94B4((void **)&v103, "minRandomTeleportTime");
  sub_21E94B4((void **)&v102, "0.0");
  v7 = (int *)sub_21E94B4((void **)&v101, "Minimum amount of time in seconds between random teleports");
  ...
  sub_21E94B4((void **)&v100, "maxRandomTeleportTime");
  sub_21E94B4((void **)&v99, "20.0");
  v11 = (int *)sub_21E94B4((void **)&v98, "Maximum amount of time in seconds between random teleports");
  ...
  sub_21E94B4((void **)&v97, "randomTeleportCube");
  sub_21E94B4((void **)&v96, "[32.0, 16.0, 32.0]");
  v15 = (int *)sub_21E94B4(
                 (void **)&v95,
                 "Entity will teleport to a random position within the area defined by this cube");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::VEC3_TYPE, (const void **)&v97, &v96, v15);
  v16 = (void *)(v95 - 12);
  ...
  sub_21E94B4((void **)&v94, "targetDistance");
  sub_21E94B4((void **)&v93, "16.0");
  v19 = (int *)sub_21E94B4((void **)&v92, "Maximum distance the entity will teleport when chasing a target");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::FLOAT_TYPE, (const void **)&v94, &v93, v19);
  v20 = (void *)(v92 - 12);
  ...
  sub_21E94B4((void **)&v91, "target_teleport_chance");
  sub_21E94B4((void **)&v90, "1.0");
  v23 = (int *)sub_21E94B4(
                 (void **)&v89,
                 "The chance that the entity will teleport between 0.0 and 1.0. 1.0 means 100%");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::FLOAT_TYPE, (const void **)&v91, &v90, v23);
  v24 = (void *)(v89 - 12);
  ...
  sub_21E94B4((void **)&v88, "lightTeleportChance");
  sub_21E94B4((void **)&v87, "0.01");
  v27 = (int *)sub_21E94B4(
                 (void **)&v86,
                 "Modifies the chance that the entity will teleport if the entity is in daylight");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::FLOAT_TYPE, (const void **)&v88, &v87, v27);
  v28 = (void *)(v86 - 12);
  ...
  sub_21E94B4((void **)&v85, "darkTeleportChance");
  sub_21E94B4((void **)&v84, "0.01");
  v31 = (int *)sub_21E94B4(
                 (void **)&v83,
                 "Modifies the chance that the entity will teleport if the entity is in darkness");
  j_DocumentationSystem::Node::addNode(v2, (int *)&DocumentationSystem::FLOAT_TYPE, (const void **)&v85, &v84, v31);
  v32 = (void *)(v83 - 12);
...
const char *__fastcall TeleportDescription::getJsonName(TeleportDescription *this)
{
  return "minecraft:teleport";
}


const char *__fastcall TeleportDescription::getDescription(TeleportDescription *this)
{
  return "Defines an entity's teleporting behavior.";
}
