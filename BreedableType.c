...
int *__fastcall BreedableType::BreedableType(int *a1, int *a2)
{
  int *v2; // r4@1
  int *v3; // r5@1
  ...
  j_DefinitionTrigger::DefinitionTrigger(v3 + 2, v2 + 2);
  return v3;
}


BreedableType *__fastcall BreedableType::~BreedableType(BreedableType *this)
{
  BreedableType *v1; // r5@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
  ...
  v1 = this;
  FilterGroup::~FilterGroup((BreedableType *)((char *)this + 16));
  v2 = *((_DWORD *)v1 + 3);
  v3 = (void *)(v2 - 12);
