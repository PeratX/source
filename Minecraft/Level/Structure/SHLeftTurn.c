...
int __fastcall SHLeftTurn::SHLeftTurn(int result)
{
  *(_DWORD *)(result + 20) = 0;
  *(_DWORD *)(result + 24) = 0;
  *(_DWORD *)(result + 12) = 0;
  ...
  *(_DWORD *)(result + 32) = 0;
  *(_DWORD *)(result + 36) = 0;
  *(_DWORD *)result = &off_2723FCC;
  return result;
}


int __fastcall SHLeftTurn::createPiece(int a1, int a2, int a3, int a4, int a5, int a6, int a7, int a8)
{
  Random *v8; // r8@1
  __int64 *v9; // r6@1
  _DWORD *v10; // r4@1
...
int __fastcall SHLeftTurn::addChildren(int a1, int a2, int a3, int a4)
{
  int result; // r0@2
...
signed int __fastcall SHLeftTurn::postProcess(SHLeftTurn *this, BlockSource *a2, Random *a3, const BoundingBox *a4)
{
  SHLeftTurn *v4; // r6@1
  __int16 *v5; // r9@1
  BlockSource *v6; // r5@1
  int v7; // r2@1
  void (__fastcall *v8)(SHLeftTurn *, BlockSource *, __int16 *, signed int); // r12@1
  signed int v9; // r3@2
  ...
  v8 = *(void (__fastcall **)(SHLeftTurn *, BlockSource *, __int16 *, signed int))(*(_DWORD *)v4 + 40);
...
signed int __fastcall SHLeftTurn::getType(SHLeftTurn *this)
{
  return 1397247060;
}


int __fastcall SHLeftTurn::SHLeftTurn(int a1, int a2, Random *this, int a4, int a5)
{
  int v5; // r5@1
  int v6; // r6@1
  int v7; // r4@1
