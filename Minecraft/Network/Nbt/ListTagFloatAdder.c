...
void **__fastcall ListTagFloatAdder::operator()(void **a1, int a2, int a3)
{
  void **v3; // r4@1
  int v4; // r8@1
  void *v5; // r5@1
...
void **__fastcall ListTagFloatAdder::operator()(void **a1, int a2)
{
  int v2; // r4@1
  void **v3; // r5@1
  void **v4; // r4@1
  ...
  v4 = ListTagFloatAdder::operator()(v3, (int)&v9, v2);
  v5 = (void *)(v9 - 12);
