...
void __fastcall DeathScreenController::~DeathScreenController(DeathScreenController *this)
{
...
DeathScreenController *__fastcall DeathScreenController::DeathScreenController(DeathScreenController *a1, int a2)
{
  DeathScreenController *v2; // r4@1
  int v3; // r0@1
  ...
  ClientInstanceScreenController::ClientInstanceScreenController((int)v2, (int)&v12);
  v6 = v13;
  if ( v13 )
  ...
  *(_DWORD *)v2 = &off_26E1934;
  DeathScreenController::_registerEventHandlers(v2);
  return v2;
}


void __fastcall DeathScreenController::_registerEventHandlers(DeathScreenController *this)
{
  ...
  v1 = this;
  sub_119C884((void **)&v19, "button.respawn_button");
  v2 = MinecraftScreenController::_getNameId(v1, (int **)&v19);
  v3 = operator new(4u);
  LODWORD(v4) = sub_1181E3C;
  *v3 = v1;
  HIDWORD(v4) = sub_1181E22;
  v17 = v3;
  v18 = v4;
  ...
  sub_119C884((void **)&v16, "button.main_menu_button");
  v6 = MinecraftScreenController::_getNameId(v1, (int **)&v16);
  v7 = operator new(4u);
  LODWORD(v8) = sub_1181F98;
  *v7 = v1;
  HIDWORD(v8) = sub_1181E74;
  v14 = v7;
  v15 = v8;
...
void __fastcall DeathScreenController::~DeathScreenController(DeathScreenController *this)
{
  DeathScreenController::~DeathScreenController(this);
}


void __fastcall DeathScreenController::_registerEventHandlers(DeathScreenController *this)
{
  DeathScreenController::_registerEventHandlers(this);
}
