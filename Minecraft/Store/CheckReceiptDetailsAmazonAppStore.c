...
void __fastcall CheckReceiptDetailsAmazonAppStore::~CheckReceiptDetailsAmazonAppStore(CheckReceiptDetailsAmazonAppStore *this)
{
  CheckReceiptDetailsAmazonAppStore::~CheckReceiptDetailsAmazonAppStore(this);
}


void __fastcall CheckReceiptDetailsAmazonAppStore::toPostBody(CheckReceiptDetailsAmazonAppStore *this, int a2)
{
  int v2; // r6@1
  void **v3; // r9@2
  int *v4; // r8@2
  ...
  CheckReceiptDetailsAmazonAppStore *v34; // [sp+8h] [bp-88h]@1
  ...
  if ( v2 != v35 )
  {
    ...
    do
    {
      ...
      sub_21E94B4((void **)&v44, "receipt_id");
...
void __fastcall CheckReceiptDetailsAmazonAppStore::~CheckReceiptDetailsAmazonAppStore(CheckReceiptDetailsAmazonAppStore *this)
{
  CheckReceiptDetailsAmazonAppStore *v1; // r0@1

  v1 = CheckReceiptDetailsAmazonAppStore::~CheckReceiptDetailsAmazonAppStore(this);
  j_j_j__ZdlPv_5((void *)v1);
}


CheckReceiptDetailsAmazonAppStore *__fastcall CheckReceiptDetailsAmazonAppStore::~CheckReceiptDetailsAmazonAppStore(CheckReceiptDetailsAmazonAppStore *this)
{
  CheckReceiptDetailsAmazonAppStore *v1; // r11@1
...
void __fastcall CheckReceiptDetailsAmazonAppStore::toPostBody(CheckReceiptDetailsAmazonAppStore *this, int a2)
{
  CheckReceiptDetailsAmazonAppStore::toPostBody(this, a2);
}


const char *__fastcall CheckReceiptDetailsAmazonAppStore::getPath(CheckReceiptDetailsAmazonAppStore *this)
{
  return "iap/amazon/1.0/check";
}


int __fastcall CheckReceiptDetailsAmazonAppStore::fromJsonResponse(CheckReceiptDetailsAmazonAppStore *this, const web::json::value *a2)
{
  web::json::value *v2; // r5@1
  CheckReceiptDetailsAmazonAppStore *v3; // r4@1
  int result; // r0@1
  ...
  void *v35; // r0@75
  __int64 v36; // r0@76
  CheckReceiptDetailsAmazonAppStore *v37; // [sp+24h] [bp-7Ch]@1
  ...
  if ( result == 4 )
  {
    ...
    if ( (_DWORD)v5 != HIDWORD(v5) )
    {
      ...
      do
      {
        ...
        sub_21E94B4((void **)&v39, "receipt_id");
