...
int __fastcall ReceiptDetailsWindowsStore::ReceiptDetailsWindowsStore(int a1, int *a2, int *a3, int *a4, char a5, int *a6, int *a7)
{
  int v7; // r4@1

  v7 = a1;
  SendReceiptDetails::SendReceiptDetails(a1, a2, a3, a4, a5);
  *(_DWORD *)v7 = &off_26E73F8;
...
int __fastcall ReceiptDetailsWindowsStore::toPostBody(ReceiptDetailsWindowsStore *this, int a2)
{
  ReceiptDetailsWindowsStore *v2; // r4@1
  int v3; // r5@1
  int *v4; // r6@1
  void *v5; // r0@3
  void *v6; // r0@4
...
void __fastcall ReceiptDetailsWindowsStore::~ReceiptDetailsWindowsStore(ReceiptDetailsWindowsStore *this)
{
  ReceiptDetailsWindowsStore::~ReceiptDetailsWindowsStore(this);
}


ReceiptDetailsWindowsStore *__fastcall ReceiptDetailsWindowsStore::~ReceiptDetailsWindowsStore(ReceiptDetailsWindowsStore *this)
{
  ReceiptDetailsWindowsStore *v1; // r5@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
...
const char *__fastcall ReceiptDetailsWindowsStore::getPath(ReceiptDetailsWindowsStore *this)
{
  return "iap/windows/1.0";
}
