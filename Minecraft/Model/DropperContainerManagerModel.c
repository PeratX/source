...
int __fastcall DropperContainerManagerModel::DropperContainerManagerModel(double a1, int a2, int a3)
{
  int v3; // r4@1

  v3 = LODWORD(a1);
  LevelContainerManagerModel::LevelContainerManagerModel(a1, a2, a3, 14);
  *(_DWORD *)v3 = &off_26ED1C8;
  ContainerManagerModel::setContainerType(v3, 7);
  (*(void (__fastcall **)(int))(*(_DWORD *)v3 + 44))(v3);
  return v3;
}


void __fastcall DropperContainerManagerModel::init(DropperContainerManagerModel *this)
{
  DropperContainerManagerModel *v1; // r4@1
  int v2; // r3@1
  int v3; // r5@1
...
void __fastcall DropperContainerManagerModel::~DropperContainerManagerModel(DropperContainerManagerModel *this)
{
  DropperContainerManagerModel::~DropperContainerManagerModel(this);
}


void __fastcall DropperContainerManagerModel::init(DropperContainerManagerModel *this)
{
  DropperContainerManagerModel::init(this);
}
