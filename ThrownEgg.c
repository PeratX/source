...
void __fastcall ThrownEgg::~ThrownEgg(ThrownEgg *this)
{
  Entity *v1; // r0@1
...
void __fastcall ThrownEgg::~ThrownEgg(ThrownEgg *this)
{
  ThrownEgg::~ThrownEgg(this);
}


void __fastcall ThrownEgg::reloadHardcoded(int a1, int a2, unsigned __int64 *a3)
{
  ThrownEgg::reloadHardcoded(a1, a2, a3);
}


Entity *__fastcall ThrownEgg::ThrownEgg(Throwable *a1, EntityDefinitionGroup *a2, const EntityDefinitionIdentifier *a3)
{
  Entity *result; // r0@1

  result = Throwable::Throwable(a1, a2, a3);
  *(_DWORD *)result = &off_26FF79C;
  *((_DWORD *)result + 62) = 31;
  return result;
}
...
signed int __fastcall ThrownEgg::getEntityTypeId(ThrownEgg *this)
{
  return 4194386;
}
