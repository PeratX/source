...
FormattedAchievementData *__fastcall FormattedAchievementData::~FormattedAchievementData(FormattedAchievementData *this)
{
  FormattedAchievementData *v1; // r5@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
...
int *__fastcall FormattedAchievementData::FormattedAchievementData(int *a1, int *a2)
{
  int *v2; // r6@1
  int *v3; // r4@1
