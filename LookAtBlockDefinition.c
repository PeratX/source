...
void __fastcall LookAtBlockDefinition::~LookAtBlockDefinition(LookAtBlockDefinition *this)
{
  LookAtBlockDefinition::~LookAtBlockDefinition(this);
}


void __fastcall LookAtBlockDefinition::~LookAtBlockDefinition(LookAtBlockDefinition *this)
{
  LookAtBlockDefinition *v1; // r4@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
  ...
  *(_DWORD *)v1 = &off_271E0B8;
  j_BehaviorTreeDefinitionPtr::~BehaviorTreeDefinitionPtr((LookAtBlockDefinition *)((char *)v1 + 8));
  v4 = *((_DWORD *)v1 + 1);
  v5 = (void *)(v4 - 12);
...
Json::Value *__fastcall LookAtBlockDefinition::load(int a1, Json::Value *a2)
{
  Json::Value *v2; // r5@1
  int v3; // r4@1
...
LookAtBlockDefinition *__fastcall LookAtBlockDefinition::~LookAtBlockDefinition(LookAtBlockDefinition *this)
{
  LookAtBlockDefinition *v1; // r4@1
  int v2; // r1@1
  void *v3; // r0@1
