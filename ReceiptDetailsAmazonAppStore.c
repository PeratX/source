...
ReceiptDetailsAmazonAppStore *__fastcall ReceiptDetailsAmazonAppStore::~ReceiptDetailsAmazonAppStore(ReceiptDetailsAmazonAppStore *this)
{
  ReceiptDetailsAmazonAppStore *v1; // r5@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
...
void __fastcall ReceiptDetailsAmazonAppStore::~ReceiptDetailsAmazonAppStore(ReceiptDetailsAmazonAppStore *this)
{
  ReceiptDetailsAmazonAppStore::~ReceiptDetailsAmazonAppStore(this);
}


int __fastcall ReceiptDetailsAmazonAppStore::ReceiptDetailsAmazonAppStore(int a1, int *a2, int *a3, int *a4, char a5, int *a6, int *a7)
{
  int v7; // r4@1

  v7 = a1;
  SendReceiptDetails::SendReceiptDetails(a1, a2, a3, a4, a5);
  *(_DWORD *)v7 = &off_26E7398;
...
const char *__fastcall ReceiptDetailsAmazonAppStore::getPath(ReceiptDetailsAmazonAppStore *this)
{
  return "iap/amazon/1.0";
}


int __fastcall ReceiptDetailsAmazonAppStore::toPostBody(ReceiptDetailsAmazonAppStore *this, int a2)
{
  ReceiptDetailsAmazonAppStore *v2; // r4@1
  int v3; // r5@1
  int *v4; // r6@1
  void *v5; // r0@3
  void *v6; // r0@4
  ...
  if ( (int *)(v33 - 12) != &dword_28898C0 )
    ...
    if ( v17 <= 0 )
      j_j_j_j__ZdlPv_9(v6);
  sub_21E94B4((void **)&v30, "receipt_id");
