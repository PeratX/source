...
void __fastcall GhastRenderer::setupScale(int a1, int a2, int _R2)
{
  __asm
  {
    VMOV.F32        S0, #4.5
...
void __fastcall GhastRenderer::~GhastRenderer(GhastRenderer *this)
{
  GhastRenderer::~GhastRenderer(this);
}


void __fastcall GhastRenderer::setupScale(int a1, int a2, int _R2)
{
  GhastRenderer::setupScale(a1, a2, _R2);
}


int __fastcall GhastRenderer::GhastRenderer(int a1, mce::TextureGroup *a2, int *a3)
{
  ...
  *a3 = 0;
  v26 = v4;
  sub_119C884((void **)&v22, "textures/entity/ghast/ghast");
  v23 = v22;
  v24 = 0;
  ...
  v26 = 0;
  *(_DWORD *)v5 = &off_26DB6B4;
  sub_119C884((void **)&v19, "textures/entity/ghast/ghast_shooting");
  v20 = v19;
  v21 = 0;
...
BaseEntityRenderer *__fastcall GhastRenderer::~GhastRenderer(GhastRenderer *this)
{
  MobRenderer *v1; // r4@1

  v1 = this;
  *(_DWORD *)this = &off_26DB6B4;
  mce::TexturePtr::~TexturePtr((GhastRenderer *)((char *)this + 644));
  return j_j_j__ZN11MobRendererD2Ev(v1);
}


int __fastcall GhastRenderer::render(int a1, BaseEntityRenderContext *a2, Ghast **a3)
{
  Ghast **v3; // r4@1
  int v4; // r6@1
  ...
  v5 = a2;
  v6 = *(_DWORD *)(a1 + 140);
  v7 = Ghast::isCharging(*a3);
  v8 = v4 + 144;
  if ( v7 )
    v8 = v4 + 644;
  return MobRenderer::renderModel(v4, v5, (int)v3, v6, v8);
}
