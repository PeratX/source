...
void __fastcall BlazeRenderer::~BlazeRenderer(BlazeRenderer *this)
{
...
_DWORD *__fastcall BlazeRenderer::BlazeRenderer(_DWORD *a1, mce::TextureGroup *a2, int *a3)
{
  ...
  *a3 = 0;
  v17 = v4;
  sub_21E94B4((void **)&v13, "textures/entity/blaze");
  v14 = v13;
  v15 = 0;
...
void __fastcall BlazeRenderer::~BlazeRenderer(BlazeRenderer *this)
{
  BlazeRenderer::~BlazeRenderer(this);
}
