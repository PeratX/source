...
int __fastcall EncryptionWarningScreenController::onOpen(EncryptionWarningScreenController *this)
{
  ...
  v1 = this;
  MinecraftScreenController::_getWeakPtrToThis<EncryptionWarningScreenController>((int)&v24, (int)this);
  sub_119C884((void **)&v23, "options.websocketEncryption");
  sub_119C884((void **)&v22, "options.websocketEncryptionWarningLabel");
  v2 = *(_QWORD *)&v24;
  if ( v25 )
  {
  ...
  *v5 = v2;
  if ( HIDWORD(v2) )
    v6 = (unsigned int *)(HIDWORD(v2) + 8);
      ...
      ++*v6;
  LODWORD(v8) = sub_1196250;
  v20 = v5;
  HIDWORD(v8) = sub_11960FC;
  *(_QWORD *)&v21 = v8;
...
void __fastcall EncryptionWarningScreenController::~EncryptionWarningScreenController(EncryptionWarningScreenController *this)
{
  MinecraftScreenController *v1; // r4@1
  void (*v2)(void); // r3@1

  v1 = this;
  *(_DWORD *)this = &off_26E1D00;
...
void __fastcall EncryptionWarningScreenController::~EncryptionWarningScreenController(EncryptionWarningScreenController *this)
{
  EncryptionWarningScreenController::~EncryptionWarningScreenController(this);
}


ScreenController *__fastcall EncryptionWarningScreenController::~EncryptionWarningScreenController(EncryptionWarningScreenController *this)
{
  MinecraftScreenController *v1; // r4@1
  void (*v2)(void); // r3@1
...
int __fastcall EncryptionWarningScreenController::EncryptionWarningScreenController(int a1, int a2, int a3)
{
  int v3; // r4@1
  int v4; // r5@1
  int v5; // r0@1
