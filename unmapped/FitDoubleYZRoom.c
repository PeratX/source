...
_DWORD *__fastcall FitDoubleYZRoom::create(_DWORD *a1, int a2, int *a3, int *a4)
{
  int *v4; // r5@1
  _DWORD *v5; // r4@1
  int v6; // r0@1
  ...
  *(_BYTE *)(*(_DWORD *)(*(_DWORD *)(v9 + 12) + 8) + 44) = 1;
  ...
  result = (_DWORD *)OceanMonumentPiece::OceanMonumentPiece((int)v10, 1, v7, (int)v4, 1, 2, 2);
  *v5 = result;
  *result = &off_271900C;
  return result;
}
...
signed int __fastcall FitDoubleYZRoom::fits(int a1, int a2)
{
  int v2; // r0@1
  signed int v3; // r8@1
  int v4; // r1@1
