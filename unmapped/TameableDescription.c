...
int __fastcall TameableDescription::parseData(TameableDescription *this, Json::Value *a2)
{
  char *v3; // r6@1
  Json::Value *v4; // r4@1
  int *v10; // r1@1
  const char *v11; // r3@5
  float v13; // [sp+0h] [bp-20h]@0
  ...
  v3 = (char *)this + 4;
  v4 = a2;
  j_Parser::parse(a2, (TameableDescription *)((char *)this + 4), (float *)"probability", (const char *)0x3F800000, v13);
  ...
  if ( (unsigned __int8)(_NF ^ _VF) | _ZF )
    v10 = _R0;
  *((_DWORD *)_R5 + 1) = *v10;
  j_Parser::parse(v4, (int)_R5 + 8, "tameItems");
  return j_j_j__ZN6Parser5parseERN4Json5ValueER17DefinitionTriggerPKc_1(
           v4,
           (TameableDescription *)((char *)_R5 + 32),
           (DefinitionTrigger *)"tame_event",
           v11);
}


void __fastcall TameableDescription::getDocumentation(int a1, int a2)
{
  TameableDescription::getDocumentation(a1, a2);
}


void __fastcall TameableDescription::~TameableDescription(TameableDescription *this)
{
  TameableDescription::~TameableDescription(this);
}
...
void __fastcall TameableDescription::getDocumentation(int a1, int a2)
{
  ...
  v2 = a2;
  sub_21E94B4((void **)&v41, "probability");
  sub_21E94B4((void **)&v40, "1.0");
  v3 = (int *)sub_21E94B4(
                (void **)&v39,
  ...
  if ( (int *)(v41 - 12) != &dword_28898C0 )
    ...
    if ( v20 <= 0 )
      j_j_j_j__ZdlPv_9(v6);
  sub_21E94B4((void **)&v38, "tameItems");
  sub_21E94B4((void **)&v37, (const char *)&unk_257BC67);
  v7 = (int *)sub_21E94B4((void **)&v36, "The list of items that can be used to tame this entity");
  ...
  sub_21E94B4((void **)&v35, "tame_event");
  sub_21E94B4((void **)&v34, (const char *)&unk_257BC67);
  v11 = (int *)sub_21E94B4((void **)&v33, "Event to run when this entity becomes tamed");
...
void __fastcall TameableDescription::~TameableDescription(TameableDescription *this)
{
  ...
  v1 = this;
  *(_DWORD *)this = &off_271F3A8;
  j_FilterGroup::~FilterGroup((TameableDescription *)((char *)this + 40));
  v2 = *((_DWORD *)v1 + 9);
  v3 = (void *)(v2 - 12);
...
const char *__fastcall TameableDescription::getJsonName(TameableDescription *this)
{
  return "minecraft:tameable";
}


const char *__fastcall TameableDescription::getDescription(TameableDescription *this)
{
  return "Defines the rules for a mob to be tamed by the player.";
}


TameableDescription *__fastcall TameableDescription::~TameableDescription(TameableDescription *this)
{
  TameableDescription *v1; // r4@1
  int v2; // r1@1
  void *v3; // r0@1
