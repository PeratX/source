...
void __fastcall FrictionModifierDescription::getDocumentation(int a1, int a2)
{
  FrictionModifierDescription::getDocumentation(a1, a2);
}


const char *__fastcall FrictionModifierDescription::getDescription(FrictionModifierDescription *this)
{
  return "Defines how much does friction affect this entity.";
}


int __fastcall FrictionModifierDescription::parseData(FrictionModifierDescription *this, Json::Value *a2, int a3, int a4, float a5)
{
  return j_j_j__ZN6Parser5parseERKN4Json5ValueERfPKcf_0(
           a2,
           (FrictionModifierDescription *)((char *)this + 4),
           (float *)"value",
...
const char *__fastcall FrictionModifierDescription::getJsonName(FrictionModifierDescription *this)
{
