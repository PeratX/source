...
Json::Value *__fastcall SelectorDefinition::load(int a1, const Json::Value *a2, unsigned __int64 *a3)
{
  int v3; // r5@1
...
void __fastcall SelectorDefinition::~SelectorDefinition(SelectorDefinition *this)
{
  SelectorDefinition *v1; // r4@1
  ...
  *(_DWORD *)v1 = &off_271E0B8;
  j_BehaviorTreeDefinitionPtr::~BehaviorTreeDefinitionPtr((SelectorDefinition *)((char *)v1 + 8));
  v4 = *((_DWORD *)v1 + 1);
  v5 = (void *)(v4 - 12);
...
void __fastcall SelectorDefinition::~SelectorDefinition(SelectorDefinition *this)
{
  SelectorDefinition::~SelectorDefinition(this);
}
