...
void __fastcall MoveControlDescription::getDocumentation(int a1, int a2)
{
  MoveControlDescription::getDocumentation(a1, a2);
}
...
void __fastcall MoveControlDescription::getDocumentation(int a1, int a2)
{
  ...
  v2 = a2;
  sub_21E94B4((void **)&v15, "max_turn");
  sub_21E94B4((void **)&v14, "30.0");
  v3 = (int *)sub_21E94B4((void **)&v13, "The maximum number in degrees the mob can turn per tick.");
...
int __fastcall MoveControlDescription::parseData(MoveControlDescription *this, Json::Value *a2, int a3, int a4, float a5)
{
  return j_j_j__ZN6Parser5parseERKN4Json5ValueERfPKcf_0(
           a2,
           (MoveControlDescription *)((char *)this + 4),
           (float *)"max_turn",
