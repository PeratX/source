...
signed int __fastcall EggItem::isThrowable(EggItem *this)
{
  return 1;
}


void __fastcall EggItem::~EggItem(EggItem *this)
{
  EggItem::~EggItem(this);
}


signed int __fastcall EggItem::dispense(EggItem *this, BlockSource *a2, Container *a3, int a4, const Vec3 *a5, int a6)
{
  BlockSource *v6; // r4@1
  int v7; // r8@1
  Container *v8; // r6@1
  ...
  EntityDefinitionIdentifier::EntityDefinitionIdentifier((void **)&v37, 4194386);
  v18 = Spawner::spawnProjectile(v17, v6, (const EntityDefinitionIdentifier *)&v37, 0, a5, (const Vec3 *)&v40);
  v19 = (void *)(v39 - 12);
...
ItemInstance *__fastcall EggItem::use(EggItem *this, ItemInstance *a2, Player *a3)
{
  ...
  v3 = a2;
  v4 = a3;
  if ( !Abilities::getBool((int)a3 + 4320, (int **)&Abilities::INSTABUILD) )
    ItemInstance::remove(v3, 1);
  ...
  Entity::getAttachPos((AABB *)&v23, (int)v4, 4, 0);
  v6(v4, 39, &v23, -1);
  if ( !Level::isClientSide(v5) )
  {
    v7 = (Spawner *)Level::getSpawner(v5);
    v8 = (BlockSource *)Entity::getRegion(v4);
    EntityDefinitionIdentifier::EntityDefinitionIdentifier((void **)&v20, 4194386);
    v9 = (const Vec3 *)(*(int (__fastcall **)(Entity *))(*(_DWORD *)v4 + 52))(v4);
    Spawner::spawnProjectile(v7, v8, (const EntityDefinitionIdentifier *)&v20, v4, v9, (const Vec3 *)&Vec3::ZERO);
    v10 = (void *)(v22 - 12);
