...
Json::Value *__fastcall MoveToDefinition::load(int a1, Json::Value *a2)
{
  Json::Value *v2; // r5@1
  int v3; // r4@1
  ...
  if ( !j_JsonUtil::parseValue<Vec3>(v5, v3 + 16) )
  {
...
void __fastcall MoveToDefinition::~MoveToDefinition(MoveToDefinition *this)
{
  MoveToDefinition::~MoveToDefinition(this);
}


MoveToDefinition *__fastcall MoveToDefinition::~MoveToDefinition(MoveToDefinition *this)
{
  MoveToDefinition *v1; // r4@1
  int v2; // r1@1
  void *v3; // r0@1
  int v4; // r1@2
  void *v5; // r0@2
  ...
  *(_DWORD *)v1 = &off_271E0B8;
  j_BehaviorTreeDefinitionPtr::~BehaviorTreeDefinitionPtr((MoveToDefinition *)((char *)v1 + 8));
  v4 = *((_DWORD *)v1 + 1);
  v5 = (void *)(v4 - 12);
