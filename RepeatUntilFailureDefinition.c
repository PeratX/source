...
void __fastcall RepeatUntilFailureDefinition::~RepeatUntilFailureDefinition(RepeatUntilFailureDefinition *this)
{
  RepeatUntilFailureDefinition::~RepeatUntilFailureDefinition(this);
}


int __fastcall RepeatUntilFailureDefinition::load(int a1, const Json::Value *a2, unsigned __int64 *a3)
{
  int v3; // r4@1
...
void __fastcall RepeatUntilFailureDefinition::~RepeatUntilFailureDefinition(RepeatUntilFailureDefinition *this)
{
  RepeatUntilFailureDefinition *v1; // r4@1
  int v2; // r0@1
  int v3; // r1@3
  void *v4; // r0@3
  ...
  *(_DWORD *)v1 = &off_271E0B8;
  j_BehaviorTreeDefinitionPtr::~BehaviorTreeDefinitionPtr((RepeatUntilFailureDefinition *)((char *)v1 + 8));
  v3 = *((_DWORD *)v1 + 1);
  v4 = (void *)(v3 - 12);
